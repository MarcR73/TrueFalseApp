...
//  TrueFalseStarter
//
//  Created by Marc Roelofs on 15/03/2017.
...
// Define datastructure to hold Questions, answers and the correct Answer.
// The number of answers must be variable, so it is an Array
